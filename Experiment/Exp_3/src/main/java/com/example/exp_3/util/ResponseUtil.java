package com.example.exp_3.util;
...
public class ResponseUtil {
    public static Object ok() {
        ...
        obj.put("errno", com.example.exp_3.util.ResponseCode.OK.getCode());
        obj.put("errmsg", com.example.exp_3.util.ResponseCode.OK.getMessage());
        return obj;
    }
    ...
    public static Object fail(com.example.exp_3.util.ResponseCode code) {
        Map<String, Object> obj = new HashMap<String, Object>();
    ...
    public static Object fail(com.example.exp_3.util.ResponseCode code, String errmsg) {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", code.getCode());
